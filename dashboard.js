...
var _user$project$Main$displayRecords = F2(
	function (model, records) {
		return _elm_lang$html$Html$text('Authenticated');
	});
				...
				return A2(
						...
						{email: _p1}),
					{
						...
						_0: _user$project$Main$saveData(
							{
								key: 'email',
								value: _elm_lang$core$Json_Encode$string(_p1)
							}),
						_1: {ctor: '[]'}
					});
			case 'Authenticate':
			...
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							bearer: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					{ctor: '[]'});
		}
	});
...
var _user$project$Main$Record = F4(
	function (a, b, c, d) {
		return {subject: a, activityArn: b, status: c, stateMachineArn: d};
	});
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {email: a, bearer: b, records: c};
	});
var _user$project$Main$BearerTokenRetrieved = function (a) {
	return {ctor: 'BearerTokenRetrieved', _0: a};
};
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('authenticate-form'),
								_1: {
									ctor: '::',
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('main-login-form'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('login-group'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$for('fp_email'),
																_1: {
																	ctor: '::',
														...
														_1: {
															...
															_0: A2(
																_elm_lang$html$Html$input,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$id('fp_email'),
																		_1: {
																			ctor: '::',
...
var _user$project$Main$view = function (model) {
	...
	if (_p2.ctor === 'Nothing') {
		...
		var _p3 = model.records;
		if (_p3.ctor === 'Nothing') {
			return _elm_lang$html$Html$text('Authenticated, loading records...');
		} else {
			return A2(_user$project$Main$displayRecords, model, _p3._0);
		}
	}
};
