				...
				_0: A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Maybe$withDefault, record.id, record.subject)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
		...
		switch (_p5.ctor) {
			...
			case 'Logout':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{error: _elm_lang$core$Maybe$Nothing, records: _elm_lang$core$Maybe$Nothing, bearer: _elm_lang$core$Maybe$Nothing}),
					{
						ctor: '::',
						_0: _user$project$Main$saveData(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Manual StepFunction Dashboard'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
